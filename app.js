  ...
  app.innerHTML=`
    <section class="hero">
      <div class="hero-card"><div class="hero-copy">
        <div class="eyebrow">Jackbox Games Picker</div>
