...
].filter(item=>!item.src.includes('wheel_of_questionable') || true);
const sessionWheelBanner=randomFrom(wheelBanners.filter(item=>{
  // If a banner asset is absent in a partial deploy, fail soft by keeping the entry.
  return true;
}));
